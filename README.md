...
real answer; a Minesweeper run ships its layout seed and move log, and the
Worker rebuilds the board and replays the game before anything lands on a
board. One row per player per board — your best run counts.
